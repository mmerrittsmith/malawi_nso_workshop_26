...
**Pacing.** Last year we overestimated how fast the group could gets through an exercise. The 2025 materials budgeted ~45 minutes for the flood exercise and ~35 for
the spatial join. Hence one exercise per day, and priority orders in place of schedules. 

**Day 1 re-treads last year's ground, at full pace.** We start by covering the same topics as Blantyre 2025
is. But assume nobody remembers any of it. 
